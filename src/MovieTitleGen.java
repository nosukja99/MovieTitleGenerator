...
public class MovieTitleGen
{
    public static void main(String[] args) throws Exception
    {
        ...
        String newAdjective = adjectives[index1];
        System.out.println("new adjective:  "+newAdjective);

        int index2 = random.nextInt(nouns.length);
        String newNoun = nouns[index2];
        System.out.println("new nouns:  "+newNoun);

       // String adjective = "Cool";
       // String noun = "Dave";

        System.out.println( "Your movie title is: " + newAdjective + " " + newNoun );
    }
